...
function fetchEntertainmentNews() {
    ...
    xhrEntertainment.open('GET', `https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=${api}`, true);
...
function fetchBusinessNews() {
    ...
    xhrBusiness.open('GET', `https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=${api}`, true);
...
function fetchSportsNews() {
    ...
    // let api = 'dbd9bad94b33424782ac9e7e017b4fa6';
    sports.open('GET', `https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=${api}`, true);
